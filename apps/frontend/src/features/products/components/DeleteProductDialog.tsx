    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          ...
          <span className="font-medium text-foreground">{product.name}</span>? This action cannot be
          undone.
        </p>
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            disabled={isPending}
            className="inline-flex h-9 items-center rounded-lg bg-danger px-4 text-sm font-medium text-white transition-colors hover:bg-danger/90 disabled:opacity-50"
          >
