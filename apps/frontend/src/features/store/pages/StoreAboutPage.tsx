      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="rounded-2xl bg-white p-6 ring-1 ring-gray-100 shadow-sm">
            <h2 className="text-xl font-bold text-gray-900 mb-4">About Our Store</h2>
          ...
          {settings?.interiorGallery && settings.interiorGallery.length > 0 && (
            <section className="rounded-2xl bg-white p-6 ring-1 ring-gray-100 shadow-sm">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Our Store</h2>
            ...
            <ul className="space-y-4">
              ...
              {settings?.openingHours && (
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-gray-900">Opening Hours</p>
