        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          {categories.map((cat) => (
            <Link
              ...
              className="group flex flex-col items-center gap-3 rounded-2xl bg-white p-8 ring-1 ring-gray-100 shadow-sm transition-all duration-300 hover:shadow-md hover:ring-primary/20 hover:-translate-y-0.5"
            >
